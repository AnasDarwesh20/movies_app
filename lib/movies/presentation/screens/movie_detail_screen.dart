  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => servicesLocator<MovieDetailsBloc>()
        ...
        ..add(
          GetRecommendationEvent(id),
        ),
      child: Scaffold(
        appBar: AppComponents.defaultAppBar(context : context),
          ...
          case RequestState.loaded:
            return CustomScrollView(
              ...
              slivers: [
                ...
                if (state.recommendation.isEmpty == false)
                  SliverPadding(
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  MovieDetailScreen(
                                      id: state
                                          .recommendation[index].movieId)));
                    },
                    child: CachedNetworkImage(
                      imageUrl: recommendation.backdropPath!.isEmpty
